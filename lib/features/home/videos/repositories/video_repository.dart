...
class MockVideoRepository implements VideoRepository {
  ...
  static final List<Map<String, dynamic>> _allMockData = [
    ...
    },
    {
      ...
      'thumbnailUrl': 'https://images.unsplash.com/photo-1519904981063-b0cf448d479e?w=400',
      'videoCount': 22,
    ...
    },
    {
      ...
      'thumbnailUrl': 'https://images.unsplash.com/photo-1482517967863-00e15c9b44be?w=400',
      'videoCount': 40,
    ...
    },
    {
      'id': 'video_019',
      'title': 'Book Fair',
      'thumbnailUrl': 'https://images.unsplash.com/photo-1543002588-bfa74002ed7e?w=400',
      'videoCount': 24,
    ...
    },
    {
      ...
      'thumbnailUrl': 'https://images.unsplash.com/photo-1606220945770-b5b6c2c55bf1?w=400',
      'videoCount': 42,
  ...
  List<VideoItemModel> _generateMockVideos(String videoAlbumId, int count) {
    ...
    final durations = ['2:30', '3:15', '1:45', '4:20', '2:10', '5:00', '3:45', '2:55', '4:10', '3:30'];
    ...
    return List.generate(
      ...
      (index) => VideoItemModel(
        ...
        createdAt: DateTime.now().subtract(Duration(days: count - index)).toIso8601String(),
      ),
    );
  }
