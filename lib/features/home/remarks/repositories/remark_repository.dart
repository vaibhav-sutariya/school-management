...
class MockRemarkRepository implements RemarkRepository {
  ...
  static final List<Map<String, dynamic>> _allMockData = [
    ...
    },
    {
      ...
      'type': 'positive',
      'severity': 'excellent',
      'description': 'Your ward possesses good etiquette and helps peers in class activities.',
    ...
    },
    {
      ...
      'type': 'positive',
      'severity': null,
      'description': 'Completes the assigned classwork within the stipulated time regularly.',
    ...
    },
    {
      ...
      'type': 'negative',
      'severity': null,
      'description': 'Late coming noted. Please ensure the student arrives by 8:00 AM.',
    ...
    },
    {
      ...
      'type': 'positive',
      'severity': null,
      'description': 'Shows great respect towards teachers and follows classroom rules.',
    ...
    },
    {
      ...
      'type': 'negative',
      'severity': 'critical',
      'description': 'Did not submit homework assignment for three consecutive days.',
    ...
    },
    {
      ...
      'type': 'positive',
      'severity': 'excellent',
      'description': 'Demonstrates excellent leadership skills in group activities.',
    ...
    },
    {
      ...
      'type': 'positive',
      'severity': null,
      'description': 'Actively participates in class discussions and asks thoughtful questions.',
    ...
    },
    {
      ...
      'type': 'positive',
      'severity': 'excellent',
      'description': 'Helps other students understand difficult concepts during study time.',
