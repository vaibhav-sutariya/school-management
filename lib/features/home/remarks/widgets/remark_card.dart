...
class RemarkCard extends StatelessWidget {
  ...
  Widget _buildIcon(BuildContext context) {
    ...
    final iconColor = isPositive ? const Color(0xFF4CAF50) : const Color(0xFFE53935);
    ...
    if (isPositive) {
      ...
      } else if (description.contains('notebook') || description.contains('noteboo')) {
  ...
  Widget _buildContent(BuildContext context) {
    final isPositive = remark.type == RemarkType.positive;
    final textColor = isPositive ? const Color(0xFF4CAF50) : const Color(0xFFE53935);
