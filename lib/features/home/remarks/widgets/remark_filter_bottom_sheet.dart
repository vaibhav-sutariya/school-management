...
class RemarkFilterBottomSheet extends StatefulWidget {
  ...
  @override
  State<RemarkFilterBottomSheet> createState() => _RemarkFilterBottomSheetState();
}
...
class _RemarkFilterBottomSheetState extends State<RemarkFilterBottomSheet> {
  ...
  Widget build(BuildContext context) {
    final hasActiveFilters = _selectedCategories.isNotEmpty || _selectedTypes.isNotEmpty;
          ...
          _FilterSection(
            ...
            items: [
              _FilterItem(
                ...
                isSelected: _selectedCategories.contains(RemarkCategory.dailyRoutine),
                onTap: () => _toggleCategory(RemarkCategory.dailyRoutine),
              ),
              _FilterItem(
                label: 'Behaviour',
                value: RemarkCategory.behaviour,
                isSelected: _selectedCategories.contains(RemarkCategory.behaviour),
                onTap: () => _toggleCategory(RemarkCategory.behaviour),
              ),
              _FilterItem(
                label: 'Class Work',
                value: RemarkCategory.classWork,
                isSelected: _selectedCategories.contains(RemarkCategory.classWork),
