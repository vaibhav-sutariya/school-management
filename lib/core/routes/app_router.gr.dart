...
import 'package:starter_app/features/home/attendance/attendance_page.dart'
    as _i1;
import 'package:starter_app/features/home/gallery/gallery_page.dart' as _i5;
import 'package:starter_app/features/home/home_screen/home_page.dart' as _i6;
import 'package:starter_app/features/notice/notice_page.dart' as _i9;
import 'package:starter_app/features/onboarding/onboarding_page.dart' as _i10;
import 'package:starter_app/features/profile/profile_page.dart' as _i13;
import 'package:starter_app/features/splash/screens/ui/splash_screen.dart'
    as _i14;
import 'package:starter_app/features/summary/summary_page.dart' as _i15;

/// generated route for
/// [_i1.AttendancePage]
class AttendanceRoute extends _i17.PageRouteInfo<void> {
  const AttendanceRoute({List<_i17.PageRouteInfo>? children})
...
class HomeRoute extends _i17.PageRouteInfo<HomeRouteArgs> {
  HomeRoute({
    _i18.Key? key,
    _i19.ScrollAwareBottomBarController? bottomBarController,
...
class HomeRouteArgs {
  ...
  final _i19.ScrollAwareBottomBarController? bottomBarController;
...
class NewPasswordRoute extends _i17.PageRouteInfo<void> {
  const NewPasswordRoute({List<_i17.PageRouteInfo>? children})
  ...
  static _i17.PageInfo page = _i17.PageInfo(
    name,
    builder: (data) {
      return const _i8.NewPasswordPage();
    },
  );
}
...
class PasswordLoginRoute extends _i17.PageRouteInfo<PasswordLoginRouteArgs> {
  PasswordLoginRoute({
    _i18.Key? key,
  ...
  static _i17.PageInfo page = _i17.PageInfo(
    ...
    builder: (data) {
      ...
      return _i11.PasswordLoginPage(key: args.key, email: args.email);
    },
  );
}
...
/// generated route for
/// [_i12.PasswordSuccessPage]
class PasswordSuccessRoute extends _i17.PageRouteInfo<void> {
  const PasswordSuccessRoute({List<_i17.PageRouteInfo>? children})
  ...
  static _i17.PageInfo page = _i17.PageInfo(
    name,
    builder: (data) {
      return const _i12.PasswordSuccessPage();
    },
  );
}
...
/// generated route for
/// [_i15.SummaryPage]
class SummaryRoute extends _i17.PageRouteInfo<void> {
  const SummaryRoute({List<_i17.PageRouteInfo>? children})
  ...
  static _i17.PageInfo page = _i17.PageInfo(
    name,
    builder: (data) {
      return const _i15.SummaryPage();
    },
  );
}

/// generated route for
/// [_i16.VerificationPage]
class VerificationRoute extends _i17.PageRouteInfo<void> {
  const VerificationRoute({List<_i17.PageRouteInfo>? children})
  ...
  static _i17.PageInfo page = _i17.PageInfo(
    name,
    builder: (data) {
      return const _i16.VerificationPage();
    },
  );
}
